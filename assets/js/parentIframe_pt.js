(function injectJS() {
  try {
    ...
    modularBars.src =
      "https://atharva-agrawal.github.io/gskPortugalPhase2/assets/js/childIframe_pt.js";
...
window.addEventListener(
  ...
  function (eventData) {
    ...
    // if(eventData.origin !== 'https://cloud.yellow.ai') return;
    let parsedData = JSON.parse(eventData.data);

    console.log("parsedData", parsedData);

    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "welcome-screen-unfilled-steps"
    ) {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "welcome-screen-filled-step1"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "welcome-screen-filled-step2"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "welcome-screen-filled-step3"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "welcome-screen"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "termsui-screen"
    ) {
      //bot ui
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "legal-copyright"
    ) {
      //bot ui
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "userwelcome-screen"
    ) {
      //bot ui
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "user-login"
    ) {
      //bot ui
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "ordercart-screen"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "load-userwelcome-screen"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "show-brand-selection"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "show-brand-detailing"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "orderhistory-screen"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "confirmorderon-bot"
    ) {
      let source = parsedData.data.data.source;
      localStorage.setItem("source", source);
      if (source == "Mobile") {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "bot-reloaded"
    ) {
      console.log("bot-reloaded");
      let data = localStorage.getItem("updated-data");
      console.log(
        "refreshed local storage data in parentIframe",
        JSON.parse(data)
      );
      let source = parsedData.data.data.source;
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "get-source"
    ) {
    ...
    if (
      parsedData?.event_code == "custom-event" &&
      parsedData?.data?.code == "continue-brandselection"
    ) {
