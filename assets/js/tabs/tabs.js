        ...
        <div class="tabs">
            <div class="tab-2 active">
                <div class="block active ${prevOrderLength ? '' : 'hide'}">
                    ...
                    <label class="tab-labels" for="tab21" id="label">${locale["labels"]["lastOrder"]}</label>
                </div>
                <div class="tab_body active" style="padding: ${prevOrderLength ? '12px 0 0 0' : '0'}">
            ...
            <div class="tab-2">
                <div class="block ${prevOrderLength ? '' : 'hide'}">
                    ...
                    <label class="tab-labels-tab2" for="tab22" id="label">${locale["labels"]["orderHistory"]}</label>
                </div>
                <div class="tab_body">
                    <div class="order_history bottom">
