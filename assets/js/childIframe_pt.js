      ...
      `<div class="mod-head-side-bar-container">
          <div class="overflow-container-sidebar">
              <ul class="sidebar-wrapper">
                  <iframe id='iframe' style="width:100%; height:100%; border: none;"  src="https://atharva-agrawal.github.io/gskPortugalPhase2/index.html"></iframe>
              </ul>
          </div>
...
window.addEventListener("message", function (eventData) {
  ...
  if (
    parsedEventData.event_code === "welcome-screen-unfilled-steps" &&
  ...
  //
  if (
    parsedEventData.event_code === "welcome-screen-filled-step1" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "welcome-screen-filled-step2" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "welcome-screen-filled-step3" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "legal-copyright" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "userwelcome-screen" &&
    parsedEventData.data
  ) {
    // remove_blur()
    document.querySelector("iframe").contentWindow.postMessage(
  ...
  if (
    parsedEventData.event_code === "ordercart-screen" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "load-userwelcome-screen" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "show-brand-selection" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "show-brand-detailing" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "orderhistory-screen" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (
    parsedEventData.event_code === "confirmorderon-bot" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
  ...
  if (parsedEventData.event_code === "bot-reloaded" && parsedEventData.data) {
    ...
    console.log("eventName---", eventName);
    console.log(
      "refreshed local storage data in childIframe",
      JSON.parse(data)
    );
  }
  ...
  if (
    parsedEventData.event_code === "continue-brandselection" &&
    parsedEventData.data
  ) {
    document.querySelector("iframe").contentWindow.postMessage(
      JSON.stringify({
